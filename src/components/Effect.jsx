...
export function LeftRibbon() {
  ...
  return (
    <canvas
      ref={ref}
      className="pointer-events-none absolute inset-y-0 left-0 w-[48%] h-full z-0"
    />
  );
}

/* =======================================================
   NEURAL BAĞLANTI ÇİZGİLERİ — Logonun sağ üst kısmında
======================================================= */
export function NeuralLinks() {
  ...
  return (
    <canvas
      ref={ref}
      className="absolute pointer-events-none z-[2] opacity-75"
      style={{
        right: "5%",
        top: "5%",
        width: "36vw",
        height: "42vh",
        transform: "rotate(15deg)", // <-- rotate yerine transform
      }}
    />
  );
}
